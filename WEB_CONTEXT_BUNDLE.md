...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-36887-sums-of-independent-random-variables-w-14d21875-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-36887"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-36887-sums-of-independent-random-variables-w-14d21875-v1",
      "problem_contract_sha256": "941bff9709ff8701813b564d5570d82e6f1f99ec8af18514dcc5a0a646636a50",
      "problem_id": "problem:um-opg-36887-sums-of-independent-random-variables-w-14d21875",
      "route_id": "route:um-opg-36887-sums-of-independent-random-variables-w-14d21875-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-36887-sums-of-independent-random-variables-w-14d21875-source-fidelity-01",
      "graph_id": "graph:um-opg-36887-sums-of-independent-random-variables-w-14d21875-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-36887-sums-of-independent-random-variables-w-14d21875-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-36887-sums-of-independent-random-variables-w-14d21875-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture If $X_1, \\dotsc, X_n \\geq 0$ are independent random variables with $\\mathbb{E}[X_i] \\leq \\mu$, then $$\\mathrm{Pr} \\left( \\sum X_i - \\mathbb{E} \\left[ \\sum X_i \\right ] < \\delta \\mu \\right) \\geq \\min \\left ( (1 + \\delta)^{-1} \\delta, e^{-1} \\right).$$"
          },
          "statement_sha256": "c9dff63f5f7fa2362a896685500e076dfcfab8eeac97f066cedc26adb0e65b32"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-36887-sums-of-independent-random-variables-w-14d21875-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-36887-sums-of-independent-random-variables-w-14d21875-root",
      "route_id": "route:um-opg-36887-sums-of-independent-random-variables-w-14d21875-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-36887-08c1b08b2dc3",
        "url": "https://www.unsolvedmath.com/problems/OPG-36887"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
